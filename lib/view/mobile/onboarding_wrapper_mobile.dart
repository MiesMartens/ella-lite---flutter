...
import 'package:ella_lite/view/mobile/onboarding_page_five_mobile.dart';
import 'package:ella_lite/view/mobile/onboarding_page_one_mobile.dart';
import 'package:ella_lite/view/mobile/onboarding_page_six_mobile.dart';
import 'package:ella_lite/view/mobile/onboarding_page_three_mobile.dart';
import 'package:ella_lite/view/mobile/onboarding_page_two_mobile.dart';
...
import 'onboarding_page_four_mobile.dart';

class OnboardingWrapperMobile extends StatefulWidget {
  const OnboardingWrapperMobile({
    super.key,
  });

  @override
  State<OnboardingWrapperMobile> createState() =>
      _OnboardingWrapperMobileState();
}

class _OnboardingWrapperMobileState extends State<OnboardingWrapperMobile> {
  OnboardingController onboardingController = Get.find<OnboardingController>();
  List<Widget> pages = [
    PageOneOnboardingMobile(),
    PageTwoOnboardingMobile(),
    PageThreeOnboardingMobile(),
    PageFourOnboardingMobile(),
    PageFiveOnboardingMobile(),
    PageSixOnboardingMobile(),
  ];
  @override
  void initState() {
