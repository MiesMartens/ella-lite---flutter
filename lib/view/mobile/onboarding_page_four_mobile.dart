...
class PageFourOnboardingMobile extends StatefulWidget {
  PageFourOnboardingMobile({
    super.key,
  });

  @override
  State<PageFourOnboardingMobile> createState() => _PageFourOnboardingState();
}

class _PageFourOnboardingState extends State<PageFourOnboardingMobile> {
